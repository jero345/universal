        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
          ...
          <a href="#inicio" className="flex-shrink-0">
            <img
              ...
              alt="Universal Agro"
              className="h-40 md:h-40 w-auto transition-all duration-300"
      ...
      <footer id="contacto" className="bg-gray-950 text-white pt-24 pb-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
            ...
            {/* Brand column */}
            <div>
              <img src="/logos/mesa-de-trabajo-2.png" alt="Universal Agro" className="h-80 w-auto mb-6"
